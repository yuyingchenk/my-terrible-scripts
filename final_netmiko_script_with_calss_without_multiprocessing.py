...
if __name__ == '__main__':
    ...
    for element in device_info:
        ...
        #Connect to devices
        Device_configuration = Device(device_info_dictionary, element[1], element[2])
        try:
            Device_configuration.connect()
            print('Successfully connect to device: ' + str(element[1]))

        except:
            print('Connection failed! ' + str(element[1]))
            continue
